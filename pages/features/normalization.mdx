...
You can find a full working example in the [array test](https://github.com/hazae41/xswr/tree/master/test/next/pages/array)
...
You can find a full working example in the [theytube test](https://github.com/hazae41/xswr/tree/master/test/next/pages/theytube)