...
Seems simple at first but you have to use a configuration for it to work like you want. Error catching requires boilerplate code. Compatibility with SSR? Unknown.